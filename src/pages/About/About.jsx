    ...
    <div className='about-page'>
        <header className='height-75'>
            <div className='container h-100 d-flex flex-column align-items-center justify-content-center text-light'>
                ...
                <p className='text-center w-75 mb-5'> WEB UNIVERSITY is renowed university which have recieved many awards on international platform</p>
            </div>
        </header>
        ...
        <div className='container my-5'>
            <div className="row">
                <div className='col-lg-6 d-flex flex-column justify-content-center mb-4 mb-lg-0'>
                    ...
                    <p>COME STUDY WITH US FOR A BRIGHT FUTURE</p>
                    <p className='mb-4 mb-lg-5'>STUDY AND SECURE A GOOD JOB AND PLACEMENT.Join us at WEB UNIVERSITY, where excellence meets opportunity! We pride ourselves on providing a vibrant and supportive learning environment where students can thrive academically, socially, and personally.</p>
                    <Link to="/contact">
